    ...
    return (
        <section className="relative mb-24 mt-10">
            ...
            <div className="grid  gap-5 lg:grid-cols-[1.15fr_0.85fr]">
                <MotionCard className="relative overflow-hidden h-[581px] rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(17,20,24,0.96),rgba(12,14,18,0.92))] p-4 shadow-[0_30px_90px_rgba(0,0,0,0.28)]">
                    <div
                        data-parallax="1.4"
                    ...
                    <div className="relative overflow-hidden rounded-[24px] border border-white/8 bg-[#0d1117]">
                        ...
                        <div className="grid min-h-[20rem] lg:grid-cols-[220px_1fr]">
                            ...
                            <div className="relative p-5 font-mono text-[13px] leading-7 text-neutral-300">
                                <div
                                    data-parallax="0.8"
                                    className="mb-5 rounded-2xl border border-[#00d4aa]/20 bg-[#101820] px-4 py-3"
                                >
                                ...
                                <div className="space-y-2">
                                    <div>
                                        export function{' '}
                                        <span className="text-[#7fb7ff]">EditorGallery</span>
                                        &#40;&#41; &#123;
                                    </div>
                                    <div className="pl-4">
                                        return{' '}
