...
const features = [
  ...
  },
  {
    ...
    desc: 'BullMQ Redis queues separate execution, AI inference, and snapshots by priority.',
  },
  {
    Icon: Database,
  ...
  },
  {
    ...
    desc: 'Redis adapter for Socket.io and Nginx sticky sessions support multi-instance scale.',
  },
]
  ...
  return (
    <section id="how" className="mb-28 reveal">
      <div className="mb-10 reveal">
        <p className="text-[11px] uppercase tracking-[0.22em] text-neutral-600 mb-4">
          About the project
        </p>
      ...
      >
        ...
        <p className="text-neutral-300 text-lg leading-[1.7]">
          Developers who want the power of VS Code, the collaboration of Figma, and the safety of
          isolated execution — all in one browser tab.
        </p>
      </div>
    </section>
  )
