    ...
    <>
      <section className="zf-section reveal" id="ai">
        <div className="zf-grid">
          <div>
            <p className="text-[10px] uppercase tracking-[0.22em] text-[#3e3e46] mb-3">
            ...
            <p className="text-[#7a7a82] text-[15.5px] leading-[1.8] mb-4">
              Orbit Code does not lock you into one model. It gives you the fastest way to
              collaborate with any AI agent, from local Ollama to cloud-hosted LLMs.
            </p>
            <p className="text-[#7a7a82] text-[15.5px] leading-[1.8] mb-2">
              Suggestions use current file context and active OT state, so output stays consistent
              with what your teammates are writing.
            </p>
      ...
      <section className="zf-section reveal">
        <div className="zf-grid">
          <div className="order-2 md:order-1 zf-visual">
            ...
            <div className="space-y-1 text-[11.5px] text-[#a8acb8]">
              <div className="rounded-md p-1.5">
                <span className="text-[10px] text-[#4a4a53] mr-2">1</span>&lt;section
                className="editor"&gt;
              </div>
              <div className="rounded-md p-1.5 bg-[rgba(0,212,170,0.06)]">
                <span className="text-[10px] text-[#4a4a53] mr-2">2</span>&lt;MonacoEditor onMount=
                {'{'}handleMount{'}'} /&gt;{' '}
                <span className="text-[#00d4aa] text-[10px]">← Alex</span>
              </div>
              <div className="rounded-md p-1.5 bg-[rgba(168,213,255,0.06)]">
                <span className="text-[10px] text-[#4a4a53] mr-2">3</span>&lt;Toolbar session={'{'}
                session{'}'} /&gt; <span className="text-[#a8d5ff] text-[10px]">← Ben</span>
              </div>
              <div className="rounded-md p-1.5">
                <span className="text-[10px] text-[#4a4a53] mr-2">4</span>&lt;/section&gt;
              </div>
            </div>
          </div>
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-[#7a7a82] text-[15.5px] leading-[1.8] mb-4">
              Share your workspace with teammates and see their cursors live. Orbit Code uses a
              custom OT engine so edits from multiple users merge without conflicts.
            </p>
            <p className="text-[#7a7a82] text-[15.5px] leading-[1.8] mb-2">
              Chat, comment with threads, and see who is working on each file from the same editor
              tab.
            </p>
            <a href="#docs" className="learn-more">
              Learn more
