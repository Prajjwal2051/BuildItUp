    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-28 relative">
            <div className="flex-1">
                ...
                >
                    <span className="hero-word hero-word-1 block text-transparent bg-clip-text"
                        style={{ backgroundImage: "linear-gradient(to bottom right, #d8e8ff, #99e6d9)" }}>
                        Orbit.
                    </span>
                    <span className="hero-word hero-word-2 block text-transparent bg-clip-text"
                        style={{ backgroundImage: "linear-gradient(to bottom right, #b5d6ff, #4ce0cc)" }}>
                        Code.
                    </span>
                    <span className="hero-word hero-word-3 block text-transparent bg-clip-text"
                ...
                <p className="hero-desc text-neutral-400 text-[16px] leading-[1.7] max-w-xl mb-10">
                    Orbit Code is a full-stack cloud IDE for real-time collaborative development.
                    Multiple developers can write, run, and debug in the browser with zero setup and zero friction.
                </p>
            ...
            <div className="hero-aside lg:w-95 lg:pt-16 shrink-0">
                ...
                <p className="text-neutral-400 text-[16px] leading-[1.6] mb-8">
                    Monaco-powered editing, Docker-sandboxed execution, and AI completions
                    from a locally hosted Ollama model.
                </p>
                ...
                <div className=" hero-ctas flex gap-4 flex-col sm:flex-row items-center ">
                    ...
                    <Link href="/auth/sign-in"
                        ...
                        style={{ border: "1px solid rgba(0,212,170,0.35)", backgroundColor: "rgba(0,212,170,0.08)" }}>
