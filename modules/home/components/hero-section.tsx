        ...
        <div className="flex flex-col lg:flex-row justify-between gap-16 mb-28 relative">
            <div className="flex-1">
                ...
                >
                    <span
                        ...
                        style={{
                            backgroundImage: 'linear-gradient(to bottom right, #d8e8ff, #99e6d9)',
                        }}
                    >
                        Orbit.
                    </span>
                    <span
                        ...
                        style={{
                            backgroundImage: 'linear-gradient(to bottom right, #b5d6ff, #4ce0cc)',
                        }}
                    >
                        Code.
                    </span>
                    <span
                        ...
                        style={{
                            backgroundImage: 'linear-gradient(to bottom right, #94c4ff, #00d4aa)',
                        }}
                    >
                        Together.
                    </span>
                ...
                <p className="hero-desc text-neutral-400 text-[16px] leading-[1.7] max-w-xl mb-10">
                    ...
                    Multiple developers can write, run, and debug in the browser with zero setup and
                    zero friction.
                </p>
            </div>
            ...
            <div className="hero-aside lg:w-95 lg:pt-16 shrink-0">
                ...
                <p className="text-neutral-400 text-[16px] leading-[1.6] mb-8">
                    Monaco-powered editing, Docker-sandboxed execution, and AI completions from a
                ...
                <ul className="space-y-4 mb-10">
                    {[
                        ...
                        <li
                            key={item}
                            className="flex items-center gap-4 text-[16px] text-neutral-200"
                        >
                            <div
