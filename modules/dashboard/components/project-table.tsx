            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <TableCell>
                  <Badge
                    variant="outline"
                    className="border-violet-300 bg-violet-100 text-violet-700 dark:border-violet-700 dark:bg-violet-900/40 dark:text-violet-200"
                  >
                    {project.template}
                  </Badge>
                </TableCell>
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    <Avatar>
                      <AvatarImage
                        src={project.user?.image || currentUserImage || undefined}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              cannot be undone. All files and data associated with this project will be permanently
              removed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
