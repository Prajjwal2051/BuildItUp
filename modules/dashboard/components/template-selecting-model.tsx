...
const TemplateSelectionModal = ({
    ...
    // This builds and sends the selected template data before closing the modal.
                ...
                {step === "select" ? (
                    <>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {filteredTemplates.length > 0 ? (
                                        filteredTemplates.map((template) => (
                                            <div
                                                key={template.id}
                                                className={"relative cursor-pointer rounded-xl border p-4 transition-colors " + (selectedTemplate === template.id ? "border-foreground bg-accent/40" : "border-border hover:border-foreground/40")}
                                                onClick={() => handleSelectTemplate(template.id)}
                                            >
                                                {selectedTemplate === template.id && (
                                                    <div className="absolute top-2 left-2 rounded-full bg-foreground p-1 text-background">
                                                        <Check size={14} />
                                                    </div>
                                                )}
                        ...
                        <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                            <div className="flex items-center text-sm text-black dark:text-white">
                                <Clock size={14} className="mr-1 text-black dark:text-white" />
                                <span>
                    ...
                    <>
                        ...
                        <div className="flex flex-col gap-6 py-4">
                            ...
                            {/* This keeps the feature summary consistent with light and dark theme colors. */}
                        ...
                        <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                            ...
                            <Button
                                className="bg-[#ffffff] hover:bg-[#d03636]"
