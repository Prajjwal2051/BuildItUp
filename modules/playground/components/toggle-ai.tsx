...
// Renders the AI button dropdown with controls for autocomplete, chat, and provider settings.
function ToggleAi({
        ...
        <DropdownMenu>
            ...
            >
                <div className="flex items-center justify-between px-2 py-1.5">
                    <span className="text-[11px] font-medium text-[#6a7280]">AI Options</span>
                    {activeProvider && (
                ...
                <DropdownMenuSeparator className="border-[#1e2028]" />

                <DropdownMenuItem
                    onSelect={onOpenSettings}
                    className="flex items-center gap-2 text-[#c9d4e5] focus:bg-[rgba(0,212,170,0.08)] focus:text-white"
                >
                    <Settings size={13} className="text-[#6a7280]" />
