...
export const metadata: Metadata = {
    ...
    description: 'Documentation for AI providers, OAuth sign-in, and getting started with Orbit Code.',
}
...
function DocsPage() {
    return (
        <div
            className="relative min-h-screen overflow-x-hidden bg-[#0a0d12] font-sans text-white antialiased"
        >
            <div
            ...
            <div className="relative z-10 flex min-h-screen flex-col">
                ...
                <main className="mx-auto flex w-full max-w-360 flex-1 flex-col gap-10 px-6 pb-24 pt-16 md:px-10 md:pt-24">
                    <section className="grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)]">
                        <div className="space-y-5">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="max-w-3xl text-[16px] leading-7 text-neutral-400 md:text-[17px]">
                                    ...
                                    provider, where AI features appear in the playground, and what
                                    to check when something fails.
                                </p>
                            </div>
                        ...
                        <div className="rounded-3xl border border-white/10 bg-[rgba(255,255,255,0.03)] p-5 shadow-[0_20px_80px_rgba(0,0,0,0.22)]">
                            ...
                            <div className="space-y-3 text-[14px] leading-6 text-neutral-300">
                                ...
                                <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                                    ...
                                    <p className="mt-1 text-neutral-400">
                                        Open AI Settings inside the playground, choose a provider,
                                        add your key if needed, then test the connection.
                                    </p>
                                </div>
                                <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                                    <p className="font-medium text-white">3. Start building</p>
                                    <p className="mt-1 text-neutral-400">
                                        Use AI chat for longer requests and AI autocomplete for fast
                                        inline code suggestions inside the editor.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <section className="grid gap-4 md:grid-cols-3">
                        <div className="rounded-3xl border border-white/10 bg-[rgba(255,255,255,0.03)] p-5">
                            ...
                            <h2 className="mt-4 text-lg font-semibold text-white">OAuth access</h2>
                            <p className="mt-2 text-[14px] leading-6 text-neutral-400">
                                Google and GitHub sign-in are the supported login paths for real
                                users.
                            </p>
                        </div>
                        <div className="rounded-3xl border border-white/10 bg-[rgba(255,255,255,0.03)] p-5">
                            <Bot className="h-5 w-5 text-[#00d4aa]" />
                            <h2 className="mt-4 text-lg font-semibold text-white">AI everywhere</h2>
                            <p className="mt-2 text-[14px] leading-6 text-neutral-400">
                                The same configured provider powers AI chat, completion tests, and
                                inline editor suggestions.
                            </p>
                        </div>
                        <div className="rounded-3xl border border-white/10 bg-[rgba(255,255,255,0.03)] p-5">
                            <ShieldCheck className="h-5 w-5 text-[#00d4aa]" />
                            <h2 className="mt-4 text-lg font-semibold text-white">Key handling</h2>
                            <p className="mt-2 text-[14px] leading-6 text-neutral-400">
                                Saved provider keys are encrypted before storage and are never sent
                    ...
                    <section className="rounded-[28px] border border-white/10 bg-[rgba(255,255,255,0.03)] p-6 md:p-8">
                        ...
                        <div className="mt-6 grid gap-4 md:grid-cols-3">
                            ...
                            <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                                ...
                                <p className="mt-2 text-[13px] leading-6 text-neutral-400">
                                    Ollama Local only works in development and expects a reachable
                                    local Ollama server.
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="grid gap-6 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
                        <div className="rounded-[28px] border border-white/10 bg-[rgba(255,255,255,0.03)] p-6 md:p-8">
                            <div className="mb-6 flex items-center gap-2">
                                <LogIn className="h-5 w-5 text-[#00d4aa]" />
                                <h2 className="text-2xl font-semibold text-white">OAuth Sign-In</h2>
                            </div>
                            <div className="space-y-4">
                        ...
                        <div className="rounded-[28px] border border-white/10 bg-[rgba(255,255,255,0.03)] p-6 md:p-8">
                            ...
                            <div className="space-y-4 text-[14px] leading-6 text-neutral-400">
                                ...
                                <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                                    ...
                                    <p className="mt-2">
                                        If the test fails, check the key format, model choice, and
                                        provider account limits before trying again.
                                    </p>
                                </div>
                                <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                                    <p className="font-medium text-white">
                    ...
                    <section className="rounded-[28px] border border-white/10 bg-[rgba(255,255,255,0.03)] p-6 md:p-8">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                                ...
                                <p className="mt-2 text-[14px] leading-6 text-neutral-400">
                                    Recheck the key format for your provider, save again, and run
                                    the connection test from AI Settings.
                                </p>
                            </div>
                            <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                            ...
                            <div className="rounded-2xl border border-white/8 bg-black/10 p-4">
                                <p className="font-medium text-white">Ollama local not working</p>
                                <p className="mt-2 text-[14px] leading-6 text-neutral-400">
                        ...
                        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                            <div>
                                ...
                                <p className="mt-2 max-w-2xl text-[14px] leading-6 text-neutral-300">
                                    Start with OAuth sign-in, then head into the dashboard and set
                                    up your AI provider inside any playground.
                                </p>
                            </div>
                            <div className="flex flex-wrap gap-3">
                                <Link
