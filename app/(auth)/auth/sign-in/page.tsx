  ...
  return (
    <section className=" items-center gap-6 pb-8 pt-6 md:py-10 lg:grid-cols-2">
      <div className="order-2 lg:order-1 rounded-2xl border border-neutral-800 bg-neutral-950/80 p-8 backdrop-blur">
        <p className="text-xs uppercase tracking-[0.24em] text-neutral-500 mb-4">Welcome to Orbit Code</p>
        ...
        <p className="text-neutral-400 leading-7 mb-8">
          Continue with Google or GitHub to access your collaborative workspace, live editor sessions,
          and version history.
        </p>
        <SignInFormClient />
      </div>
